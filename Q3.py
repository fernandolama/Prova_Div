...
cidades = [
            {'id': 3, 'cidade': 'Diamantina', 'estado_id': 1},
            {'id': 4, 'cidade': 'Noronha', 'estado_id': 2}
        ]

bairros = [
            {'id': 5, 'bairro': 'Betânia', 'cidade_id': 3, 'estado_id': 1},
            {'id': 6, 'bairro': 'Agostinho', 'cidade_id': 4, 'estado_id': 2},
            {'id': 7, 'bairro': 'Natal', 'cidade_id': 4, 'estado_id': 2}
        ]